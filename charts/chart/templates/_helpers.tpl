...
*/}}
{{- define "kube-symbiont.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kube-symbiont.resourceName" -}}
{{- $fullname := include "kube-symbiont.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "kube-symbiont.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "kube-symbiont.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
